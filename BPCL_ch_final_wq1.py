...
if __name__ == '__main__':
	try:
		global wat_check
		global wat_rectify
		#cam = cv2.VideoCapture("../ch.avi")#/media/smartcow/LFS/temp/20201010183402.mp4")
		...
		#kk = 0
		while True:
			#cam = cv2.VideoCapture("../ch.avi")#/home/smartcow/LFS/vid.avi")
			...
			if moving == True:
				...
				if cv2.waitKey(1) & 0xFF == ord('q'):
					break'''
			#print("Moving -> {}  and Prev_moving -> {}".format(moving,prev_moving))
